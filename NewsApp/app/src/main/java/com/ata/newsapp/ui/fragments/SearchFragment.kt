...
import com.ata.newsapp.databinding.FragmentSearchBinding
import com.ata.newsapp.ui.NewsActivity
import com.ata.newsapp.ui.NewsViewModel
import com.ata.newsapp.util.Constants
import com.ata.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.searchEdit.addTextChangedListener(object : TextWatcher {
            ...
            private fun delay(searchNewsTimeDelay: String) {
            ...
            when (response) {
                ...
                is Resource.Error -> {
                    ...
                    response.message?.let { message ->
                        Toast.makeText(activity, "Üzgünüm hata: $message", Toast.LENGTH_LONG).show()
