...
import com.ata.newsapp.databinding.FragmentHeadlinesBinding
            ...
            when(response) {
                is Resource.Success<*> -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages =  (newsResponse.totalResults ) + 2
...
operator fun Int.compareTo(queryPageSize: String): Int {
